...
Fit_results Fit_head(string _draw_results, int fix_params, int ch ){
  ...
  starting_sigma_L_1=0.079;
  starting_sigma_H_1=0.100;
  ...
  if(ch==1||ch==2){starting_delta_means_L=0.2;}
  ...
  /*
    RooAbsReal* nll_model_0 = model_0.createNLL(ds_0,Save(),Range("Fit_Range_0"),SumW2Error(kFALSE),Extended(kFALSE)) ;
    RooMinuit RMN_0 = RooMinuit(*nll_model_0);
    RMN_0.setWarnLevel(0);
    ...
    RooFitResult* fit_results_0=RMN_0.fit("shr") ;
  */
  ...
  cout<<"STATUS MIGRAD EDM 0 0"<<endl;
    ...
    sigma_L_0.setConstant(kTRUE);
    sigma_H_0.setConstant(kTRUE);
    RooFitResult* fit_results_0_b = model_0_b.fitTo(ds_0,Range("Fit_Range_0"),Save(),Extended(kFALSE),SumW2Error(kFALSE),PrintLevel(1),PrintEvalErrors(-1),Warnings(kFALSE),Verbose(kFALSE));//);
    sigma_L_0.setConstant(kFALSE);
    sigma_H_0.setConstant(kFALSE);
    //Delta_H_0.setConstant(kFALSE);
  ...
  RooFitResult* fit_results_0 = model_0.fitTo(ds_0,Range("Fit_Range_0"),Save(),Strategy(2),SumW2Error(kFALSE),PrintLevel(1),PrintEvalErrors(-1),Warnings(kFALSE),InitialHesse(true));//,Hesse(kFALSE));//,Extended(kFALSE),Verbose(kFALSE));//);
  ...
  */
  ...
  sigma_L_1.setConstant(kTRUE);
  sigma_H_1.setConstant(kTRUE);
  RooFitResult* fit_results_1_b = model_1_b.fitTo(ds_1,Range("Fit_Range_1"),Save(),Extended(kFALSE),SumW2Error(kFALSE),PrintLevel(1),PrintEvalErrors(-1),Warnings(kFALSE),Verbose(kFALSE));//);
  sigma_L_1.setConstant(kFALSE);
  sigma_H_1.setConstant(kFALSE);
  //Delta_H_1.setConstant(kFALSE);
  ...
  RooFitResult* fit_results_1 = model_1.fitTo(ds_1,Range("Fit_Range_1"),Save(),Strategy(2),SumW2Error(kFALSE),PrintLevel(1),PrintEvalErrors(-1),Warnings(kFALSE),InitialHesse(true));//,Hesse(kFALSE));//,Extended(kFALSE),Verbose(kFALSE));//);
  ...
  sigma_L_1.setConstant(kTRUE);
  sigma_H_1.setConstant(kTRUE);
  RooFitResult* fit_results_b = model_b.fitTo(DS,Range("Fit_Range"),Save(),Extended(kFALSE),SumW2Error(kFALSE),PrintLevel(1),PrintEvalErrors(-1),Warnings(kFALSE),Verbose(kFALSE));//);
  sigma_L_1.setConstant(kFALSE);
  sigma_H_1.setConstant(kFALSE);
  sigma_L_0.setConstant(kFALSE);
  sigma_H_0.setConstant(kFALSE);
  ...
  */
  ...
  //  RooFitResult* fit_results_1 = model_1.fitTo(ds_1,Range("Fit_Range_1"),Save(),Strategy(2),SumW2Error(kFALSE),PrintLevel(1),PrintEvalErrors(-1),Warnings(kFALSE),InitialHesse(true));//,Extended(kFALSE),Verbose(kFALSE));//);
  RooFitResult* fit_results = model.fitTo(DS,Range("Fit_Range"),Save(),Strategy(2),SumW2Error(kFALSE),PrintLevel(1),PrintEvalErrors(-1),Warnings(kFALSE),InitialHesse(true));//,Hesse(kFALSE));//
  fit_results->Print("v");
...
vector<float> loop_channels(int deep_fixed_params,bool plot_summaries){ //rel_weight is the relative weight of the 1 to 0 pois, i.e. total dataset= pos.0 + rel_weight*pos.1 - in the real case rel_weight=1.0
  ...
  for(Int_t i=0; i<16; i++){
    ...
    //RESULTS.push_back(my_fit_Results);
      ...
      c_pos0_AllChannels_pulls->cd(index_channel_pixel[i]); gPad->SetGridy(); my_fit_Results.xframe2_pull_0->Draw();
      c_pos1_AllChannels_pulls->cd(index_channel_pixel[i]); gPad->SetGridy(); my_fit_Results.xframe2_pull_1->Draw();
      ...
      c_pos01_AllChannels_pulls->cd(index_channel_pixel[i]); gPad->SetGridy(); my_fit_Results.xframe2_pull_01->Draw(); 
